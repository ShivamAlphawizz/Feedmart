...
extension colors on ColorScheme {
  ...
  static MaterialColor secondary_app = const MaterialColor(
    0xffFC6A57,
    const <int, Color>{
      50:  secondary,
      100: secondary,
  ...
  static const Color primary = Color(0xff09366F);
  static const Color secondary = Color(0xffF9960F);
  static const Color button = Color(0xffFCC780);

  Color get darkMode =>
      this.brightness == Brightness.dark ? secondary : primary;
  ...
  static const Color grad1Color = Color(0xff09366F);
  static const Color grad2Color = Color(0xff09366F);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xff09366F);

  Color get lightBlack =>
      this.brightness == Brightness.dark ? whiteTemp : const Color(0xff09366F);

  Color get darkgray =>
      this.brightness == Brightness.dark ? whiteTemp : const Color(0xffB8B8B8);
