final String appName = 'FEED MART';

final String packageName = 'com.feedmart.User';
final String androidLink = 'https://play.google.com/store/apps/details?id=';

final String iosPackage = 'com.feedmart.User';
...
final String baseUrl = 'https://developmentalphawizz.com/feedmart/app/v1/api/';
final String imageUrl = 'https://developmentalphawizz.com/feedmart/';
