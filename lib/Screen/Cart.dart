...
import 'package:eshop_multivendor/Helper/upi_payment.dart';
import 'package:eshop_multivendor/Helper/user_custom_radio.dart';
...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  addDeliveryCharge(String addId)async{
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        print("final value here is now ${finalValues}");
  ...
  removeCart(String vid)async{
    ...
    print("remove cart ${vid} and ${CUR_USERID}");
    print("dd ${baseUrl}remove_from_cart");
    var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}remove_from_cart'));
    request.fields.addAll({
      'user_id': '${CUR_USERID}',
    ...
    if (response.statusCode == 200) {
      ...
      print("remove result ${jsonRessult['message']}");
      _getCart("0");
      setState(() {
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Padding(
                    ...
                    child: Text("Cart",style: TextStyle(color: colors.whiteTemp,fontSize: 20,fontWeight: FontWeight.bold),),
                  ),
                ),
              ),
              Expanded(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                      ...
                                      child: GestureDetector(
                                        ...
                                        onTap: () {
                                          ...
                                          if (context.read<CartProvider>().isProgress ==
                                            ...
                                            //     selectedPos);
                                            removeCart(cartList[index].varientId.toString());
                                        },
                                      ),
                                    ),
                                  ),
                            ...
                            //   child: Text("PackSize: ${cartList[index].productList![0].weight} ${cartList[index].productList![0].prVarientList![0].unittext}",style: TextStyle(color: colors.blackTemp),),
                            // ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Row(
                                    children: [
                                      Container(
                                        width: 200,
                                        child: Text(
                                          double.parse(cartList[index].productList![0].prVarientList![selectedPos].price!) != 0
                                              ?  "Price: " + CUR_CURRENCY! +
                                              "" +
                                              cartList[index]
                                                  .productList![0]
                                  ...
                                  // Text("MRP: $CUR_CURRENCY ${cartList[index]
                                  //     .productList![0]
                                  //     .prVarientList![selectedPos]
                                  //     .price!}",
                                  //   // " MRP:" + CUR_CURRENCY! + " " + price.toString(),
                                  //   style: Theme.of(context)
                                  //       .textTheme
                                  //       .overline!
                                  //       .copyWith(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        // Text("Size:${cartList[index].productList![0].weight!} ${cartList[index].productList![0].prVarientList![0].unittext}",style: TextStyle(color: colors.blackTemp),),
                        cartList[index]
                            .productList![0]
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            // Text(double.parse(cartList[index].productList![0].prVarientList![selectedPos].price!) != 0 ? "Price:"+CUR_CURRENCY! + " " + cartList[index].productList![0].prVarientList![selectedPos].disPrice! + "/" + " PeckSize:${cartList[index].productList![0].weight!} ${cartList[index].productList![0].prVarientList![0].unittext}"
                            //        : "",
                            //    maxLines: 1,
                            //    overflow: TextOverflow.ellipsis,
                            //    style: TextStyle(
      ...
      try {
        if(addressList.isEmpty){
          ...
          parameter = {
            ...
            SAVE_LATER: save,
            'state_id': '${stateId}',
            'address_id': '${addressList[selectedAddress!].id}'
          };
          print(" cart para ${parameter}");
        }
        Response response =
        ...
        print("ok now ${getCartApi}");
        print("ok parametre===>${parameter}");
        ...
        if (!error) {
          ...
          setState(() {
            ...
            finalAmount = getdata['total_arr'].toString();
    ...
    if (!remove &&
      ...
      if (_isNetworkAvail) {
        try {
          ...
          print("remove cart api ${manageCartApi}");
          print("remove para ${parameter}");
          Response response =
          await post(manageCartApi, body: parameter, headers: headers)
              .timeout(Duration(seconds: timeOut));
          var getdata = json.decode(response.body);
    ...
    return Container(
        child: Text(getTranslated(context, 'NO_CART')!,
            style: Theme.of(context).textTheme.headline5!.copyWith(
                color: colors.secondary, fontWeight: FontWeight.normal)));
  }
  ...
  checkout(List<SectionModel> cartList) {
    print("nnnnnnnnnnnnnnnnnnnnn++++++${totalamount.toString() + "nnnnnnnnnnnnn1${cartList}" }");
    print("nnnnnnnnnnnnn1${cartList}");
    _razorpay = Razorpay();
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        payMethod == "Cash On Delivery" ?  Text(
                                          "₹ ${double.parse(finalAmount.toString()) + double.parse(dCharge.toString())}",
                                          // "${int.parse(finalAmount!) + int.parse(dCharge)}",
                                          style: TextStyle(
                                              color: Theme.of(context)
                                                  .colorScheme
                                                  .fontColor,
  ...
  doPayment() {
    ...
    if (payMethod == getTranslated(context, 'PAYPAL_LBL')) {
      ...
      UpiPayment upiPayment = new UpiPayment(totalamount!,
        upi.toString(),
        context, (value) {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        await post(getAddressApi, body: parameter, headers: headers)
            .timeout(Duration(seconds: timeOut));
        print("getAdd${getAddressApi.toString()}");
        print("PApap${parameter.toString}");
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    print("this is Success${response} btggt ${response.paymentId}");
  ...
  void _handlePaymentError(PaymentFailureResponse response) {
    // print("this is _handlePaymentError");
  ...
  void _handleExternalWallet(ExternalWalletResponse response) {
    print("this is _handleExternalWallet");
  }
  updateCheckout() {
                  ...
                  Row(
                    children: [
                      Expanded(
                          child:
                          radioData == null ?Text(
                            addressList[selectedAddress!].name.toString() +
                                ", " +
                                addressList[selectedAddress!].mobile.toString() +
                                ", " +
                                ...
                                ", " +
                                addressList[selectedAddress!].country.toString() +
                                ", " +
                                addressList[selectedAddress!].pincode.toString(),
                          ) :
                          Text("${radioData!.name}, ${radioData!.addItem!.address}, ${radioData!.addItem!.cityId}, ${radioData!.addItem!.state}, ${radioData!.addItem!.country}")),
                      InkWell(
                        child: Padding(
                          padding:
                          const EdgeInsets.symmetric(horizontal: 8.0),
  ...
  //
  //           totalPrice = double.parse(data["final_total"])  + double.parse(dCharge.toString());
  //           // + double.parse(dCharge.toString());
  //
  ...
  //           var data = getdata["data"];
  //
  //           totalPrice = double.parse(data["final_total"]) + dCharge;
  //
  //           setSnackbar(msg!, _checkscaffoldKey);
  //         }
  //         if (isUseWallet!) {
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    getTranslated(context, 'MINIMUM_PAYMENT')!,
                                    style: Theme.of(context)
                                        .textTheme
                                        .subtitle2!
                                        .copyWith(
                                  ...
                                  // Text("${advancePercentage.toString}"),
                                  payMethod == "Cash On Delivery" ?  Text(
                                    CUR_CURRENCY! +
                                        " " +
                                        "0.00",
