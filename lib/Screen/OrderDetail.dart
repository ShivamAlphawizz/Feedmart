...
class OrderDetail extends StatefulWidget {
  ...
  const OrderDetail({Key? key, this.model,this.sellerId,this.orderId}) : super(key: key);
            ...
            child:
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("${getTranslated(context, 'BALANCE_AMOUNT')!} :",
                  ...
                  widget.model!.walBal == "0" ?SizedBox.shrink(): Padding(
                    padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  widget.model!.promoDis == "0" ?SizedBox.shrink(): Padding(
                padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                  ...
                  widget.model!.advanceAmount == "0"?SizedBox.shrink(): Padding(
                    padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(getTranslated(context, 'MINIMUM_PAYMENT')! + " " + ":",
                            style: Theme.of(context).textTheme.button!.copyWith(
                                color: Theme.of(context).colorScheme.black)),
                  ...
                  widget.model!.remainingAmount == "0"?SizedBox.shrink(): Padding(
                    padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  //     mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  //     children: [
                  //       Text(getTranslated(context, 'PAYABLE_BALANCE')! + " " + ":",
                  //           style: Theme.of(context).textTheme.button!.copyWith(
                  //               color: Theme.of(context).colorScheme.lightBlack2)),
                  //
                  //       widget.model!.payMethod == "COD" ? Text("- " + CUR_CURRENCY! + " " + "0.00",
                  //           style: Theme.of(context).textTheme.button!.copyWith(
                  //               color: Theme.of(context).colorScheme.lightBlack2)) : Text("- " + CUR_CURRENCY! + " " + widget.model!.advanceAmount.toString(),
                  //           style: Theme.of(context).textTheme.button!.copyWith(
                  //               color: Theme.of(context).colorScheme.lightBlack2))
                  //     ],
                  //   ),
        ...
        child: Padding(
            ...
            child:
              ...
              Padding(
                  padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                  child: Text(
                    widget.model!.name! + ",",style: TextStyle(color: Theme.of(context).colorScheme.fontColor,fontWeight: FontWeight.bold),
                  )),
              Padding(
                  padding: EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
