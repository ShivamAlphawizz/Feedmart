...
class StateProduct extends State<ProductList> with TickerProviderStateMixin {
  ...
  checkStatus() async{
   var onOff = await checkOnOff(widget.id.toString());
                        ...
                        child: Padding(
                          ...
                          child: Container(
                              child: Padding(
                                ...
                                child: widget.fromSeller! ? null : getAppBar(widget.name!, context),
                              )),
                        )
                    ),
                  ),
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        child: Row(
                                          children: [
                                            Text(
                                                "Price: " + CUR_CURRENCY! + " " + price.toString() + "/"),
                                            Text( model.prVarientList![0].weight == "1" ? "${model.prVarientList![0].unittext.toString()}" :  model.prVarientList![0].weight.toString() + " " + model.prVarientList![0].unittext.toString(),
              ...
              child: InkWell(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                      Icons.shopping_cart_outlined,color: colors.secondary,
                      size: 15,
                    ),
                  ),
                ),
                          ...
                          child: Padding(
                            ...
                            child: Icon(
                              !data.contains(model.id)
                                  ...
                                  : Icons.favorite,color: colors.secondary,
                              size: 15,
                            ),
                          ),
                          onTap: () {
      ...
      children: [
        ...
        Expanded(
          child: productList.length == 0
            ...
            children: [
              SizedBox(height: 50,),
                Text("Aah!",style: TextStyle(color: colors.blackTemp,fontWeight: FontWeight.bold,fontSize: 15),),
                SizedBox(height: 10,),
                Text("Currentiy Unavailable,",style: TextStyle(color: colors.blackTemp,fontWeight: FontWeight.bold,fontSize: 15),),
               SizedBox(height: 20,),
                Text("COMING SOON...",style: TextStyle(color: colors.secondary,fontWeight: FontWeight.bold,fontSize: 20),),
              SizedBox(height: 20,),
              Text("NO item found..!!",style: TextStyle(color: colors.secondary,fontWeight: FontWeight.bold,fontSize: 15),),
            ],
          ),
              )
              : listType
                 ...
                 child: Container(
                   ...
                   child: Center(
                     child: Text("BACK",style: TextStyle(
                         color: colors.whiteTemp,fontWeight: FontWeight.bold,fontSize: 15
                     ),),
                   ),
                 ),
               ),
