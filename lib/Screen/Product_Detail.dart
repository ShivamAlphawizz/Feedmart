...
import 'package:eshop_multivendor/Helper/design.dart';
...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (widget.model!.videType != null &&
        ...
        widget.model!.video != "") {
      sliderList.add(widget.model!.image);
     // sliderList.add(widget.model!.video);
    }
            ...
            children: [
              Container(
                child: Row(
                  children: [
                    Text(
                        "Price: " + CUR_CURRENCY! + " " + price.toStringAsFixed(0) + "/",style: TextStyle(fontWeight: FontWeight.bold),),
                    Text( widget.model!.prVarientList![0].weight == "1" ? "${widget.model!.prVarientList![0].unittext.toString()}" :  widget.model!.prVarientList![0].weight.toString() + " " + widget.model!.prVarientList![0].unittext.toString(),
              ...
              children: <Widget>[
                Column(
                  ...
                  children: [
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                           crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                            Text("Instruction",style: TextStyle(color: Theme.of(context).colorScheme.lightBlack,fontWeight: FontWeight.bold),),
                              widget.model!.instruction == null || widget.model!.instruction == " "
                                  ?SizedBox.shrink():
                                  SizedBox(height: 5,),
                              Container(
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 5,right: 10),
                                  child: Text("${widget.model!.instruction}",textAlign: TextAlign.justify,
                    ...
                    //          // getTranslated(context, 'INSTRUCTION')!,
