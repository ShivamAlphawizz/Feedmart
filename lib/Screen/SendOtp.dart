...
class _SendOtpState extends State<SendOtp> with TickerProviderStateMixin {
  ...
  Future<void> getVerifyUser() async {
    try {
      ...
      print("this is a send Otp=============>${getVerifyUserApi.toString()}");
      print(data.toString());
      print("REREFERERERERE_______${response}");

      var getdata = json.decode(response.body);
      print(getVerifyUserApi.toString());
      print(data.toString());
      print("REREFERERERERE_______}");
      bool? error = getdata["error"];
      String? msg = getdata["message"];
      var dev = getdata["data"];
      print("daradatdatfaf${dev}");
      await buttonController!.reverse();
