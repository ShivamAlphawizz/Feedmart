...
void main() async {
 ...
 // FirebaseMessaging.onBackgroundMessage(myForgroundMessageHandler);
  ...
  FirebaseMessaging.instance.getToken().then((value) {
   print("checking token here ${value}");
  });
  runApp(
      ...
      return MultiProvider(
          ...
          child: MaterialApp(
            ...
            darkTheme: ThemeData(
              ...
              primarySwatch: colors.secondary_app,
              primaryColor: colors.secondary_app,
              ...
              iconTheme: Theme.of(context).iconTheme.copyWith(color: Color(0xffF9960F)),
              //colors.secondary),
              textTheme: TextTheme(
                      headline6: TextStyle(
                        color: Theme.of(context).colorScheme.fontColor,
